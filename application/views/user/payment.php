        ...
        <div id="Checkout" class="inline">
            ...
            <form action="<?= base_url('StripeController/submit') ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="CreditCardNumber" name="card_number" class="null card-image form-control" type="text"></input>
                </div>
                <div class="expiry-date-group form-group">
                    <label for="ExpiryDate">Expiry date</label>
                    <input id="ExpiryDate" name="expiry_date" class="form-control" type="text" placeholder="MM / YY" maxlength="7"></input>
                </div>
                
                <div class="security-code-group form-group">
                    <label for="SecurityCode">Security code</label>
                    <div class="input-container">
                        <input id="SecurityCode" class="form-control" name="security_code" type="text"></input>
                ...
                <button id="PayButton" class="btn btn-block btn-success submit-button mt-4" type="submit">
                    ...
                    <span class="align-middle">Pay <?= $final_cost['price'] ?></span>
                </button>
            </form>
        </div>
    </div>
