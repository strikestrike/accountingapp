        ...
        <div class="project-nav">
            <div class="card-action card-tabs card-tabs2 w-100">
                <ul class="nav nav-tabs style-2 w-100" id="ListViewTabLink">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('user/stocksIncome') ?>" class="nav-link">Income Type</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="col-xl-12">
                                <div class="project-main2">
                                    ...
                                    <div class="basic-form">
                                        <form action="<?= !empty($existingVerification['id']) ? base_url('user/updateStocksVerification') : base_url('user/saveStocksVerification') ?>" method="POST">
                ...
                if (error == 0) {
                    for (let i = 0; i < country.length; i++) {
                        var obj = {
                            ...
                            'country': country[i],
                            'var_final': divident[i]
                        }
                        data.push(obj);
                    }
                    $.ajax({
                        url: "<?= base_url('user/processStocks') ?>",
                        method: 'POST',
                        data: {
                            data
                        },
