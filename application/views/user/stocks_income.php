                ...
                <ul class="nav nav-tabs style-2 w-100" id="ListViewTabLink">
                    ...
                    <li class="nav-item">
						<?php if($personalData['steps_completed'] >= 2){ ?>
							<a href="stocksVerification" class="nav-link">Information Verification</a>
						<?php } else { ?>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="project-main2">
                                    <span class="arrow-up-back"></span>
                                    <span class="arrow-up"></span>
                                    <form action="<?= base_url() ?>user/saveStocksIncome" enctype="multipart/form-data" method="POST">
                                        <div class="row justify-content-between align-items-center">
                                            <?php if (!empty($stocksIncome)) { ?>
                                            ...
                                            <?php } else { ?>
                                                <div class="col-xl-4 col-lg-4 col-sm-6 mb-3">
                                                    ...
                                                    <p class="mb-0 small">If you don't have a valid .xls file, <a href="<?= base_url() . 'user/stocksVerification' ?>">click here</a></p>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-sm-6 mb-3 d-flex justify-content-end">
                                                <?php if (!empty($stocksIncome)) { ?>
                                                    ...
                                                    <?php }elseif($personalData['steps_completed'] >= 2){ ?>
                                                        <a href="stocksVerification" class="btn btn-primary nextStep"><i class="fas fa-forward"></i> Next</a>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table">
                                                                <thead>
                                                                    ...
                                                                    <th scope="col">VAR Final</th>
                                                                </thead>
                                                                <tbody>
                                                                    <?php
                                                                    $i = 1;
                                                                    // echo "<pre>";print_r($stocksIncome);echo "</pre>";
                                                                    foreach ($stocksIncome as $key => $value) {
                                                                        echo "
                                                                                <tr>
                                                                                    <td>" . $i++ . "</td>
                                                                                    <td>" . $value['country'] . "</td>
                                                                                    <td>" . $value['SUM(var_final)'] . "</td>
                                                                                </tr>
                                                                            ";
                                                                    }
                                                                    ?>
...
<script>
    window.addEventListener('load', () => {
        ...
        var modules = <?= json_encode($stocksModulesPrice) ?>;
        // console.log(modules);
        setPrice(modules);
...
<script>
    ...
    function saveFinalCost() {
        ...
        $.ajax({
            ...
            data: data,
            success : function(response){
                window.location.href = "<?= base_url('user/stocksVerification') ?>";
            },
            error: function(){
