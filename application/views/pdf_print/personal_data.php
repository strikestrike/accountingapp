...
<body>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 25%; ">
                            <div>
                                <label class="radio-inline me-3"><input type="radio" value="<?= $personal_data->salutation; ?>" name="optradio"> Mr</label>
                                <label class="radio-inline me-3"><input type="radio" value="<?= $personal_data->salutation; ?>" name="optradio"> Mrs</label>
                            </div>
                        </td>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 80%; "><input type="text" class="form-control" value="<?= $personal_data->name_surname; ?>" placeholder="Aasasasa" style="background: #fafafa;
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 80%; "><input type="text" class="form-control" value="<?= $personal_data->per_number; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:90%; vertical-align: middle;"></td>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 80%; "><input type="text" class="form-control" value="<?= $personal_data->mob_number; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:90%; vertical-align: middle;"></td>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 25%; "><input type="text" class="form-control" value="<?= $personal_data->nationalid; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:80%; vertical-align: middle;"></td>
                        <td style=" width: 25%; "><input type="text" class="form-control" value="<?= $personal_data->nationalid2; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:80%; vertical-align: middle;"></td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 80%; "><input type="text" class="form-control" value="<?= $personal_data->birthday; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:90%; vertical-align: middle;"></td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 25%; "><input type="text" class="form-control" value="<?= $personal_data->address; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:80%; vertical-align: middle;"></td>
                        <td style=" width: 25%; "><input type="text" class="form-control" value="<?= $personal_data->address2; ?>" placeholder="Aasasasa" style="background: #fafafa;
    border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:80%; vertical-align: middle;"></td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style=" width: 80%; "><input type="text" class="form-control" value="<?= $personal_data->address3; ?>" placeholder="Aasasasa" style="background: #fafafa;
        border: 0.0625rem solid #EEEEEE; padding: 0.3125rem 1.25rem; color: #6e6e6e; height: 45px; border-radius: 0.5rem; width:90%; vertical-align: middle;"></td>
