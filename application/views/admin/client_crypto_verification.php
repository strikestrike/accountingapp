        ...
        <div class="project-nav">
            <div class="card-action card-tabs card-tabs2 w-100">
                <ul class="nav nav-tabs style-2 w-100" id="ListViewTabLink">
                    <li class="nav-item">
                        <a href="<?= base_url('admin/clientPersonalData/'.$personalData['id']) ?>" class="nav-link">Personal Data </a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="col-xl-12">
                                <div class="project-main2">
                                    ...
                                    <div class="basic-form">
										<?php 
											// echo "<pre>"; print_r($ong_data); echo "</pre>"; 
										?>
                                        <form action="<?= base_url('admin/saveCryptoVerification') ?>" method="POST">
											<input type="hidden" name="id" value="<?= $existingVerificationData['id'] ?? '' ?>">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="text" name="ong_name" id="ong_name" class="form-control" value="<?= $ong_data['ong_name'] ?? '' ?>" placeholder="ONG Name" required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <label class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="number" name="ong_registration_number" id="ong_registration_number" class="form-control" value="<?= $ong_data['ong_registration_number'] ?? '' ?>" placeholder="Registration No." required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <label class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="number" name="ong_bank_account" id="ong_bank_account" class="form-control" value="<?= $ong_data['ong_bank_account'] ?? '' ?>" placeholder="A/c. 123XXXXXXXXXX" required>
                                                </div>
                                            </div>
