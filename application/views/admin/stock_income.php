                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="project-main2">
                            <span class="arrow-up-back"></span>
                            <span class="arrow-up"></span>
                            <form action="<?= base_url('Admin/stock_income'); ?>" method="post" enctype="multipart/form-data">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-sm-6 mb-3 d-flex justify-content-end">
                                        <!-- <a class="btn btn-primary" href="<?= base_url('Admin/stock_verification'); ?>" data-bs-toggle="modal" data-bs-target="Admin/stock_verification">
                                                         <img src="<?= base_url(); ?>assets/img/u.png" alt="">&nbsp; Process data</a> -->
                                        <input type="submit" name="save" <img src="<?= base_url(); ?>assets/img/u.png" class="btn btn-primary" value="Process data">
                                    </div>
