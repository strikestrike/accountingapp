                    ...
                    <div class="col-xl-12">
                        <div class="project-main2">
                            ...
                            <div class="basic-form">
                                <form method="POST" action="<?php echo base_url() . 'Admin/crypto_income1' ?>">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="income1" class="form-control">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('income1'); ?></span>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="tooltip-info">
                                                <span><a href="javascript:void(0);" class="info-btn"><i class="fa fa-info"></i></a></span>
                                                <div class="main">
                                                    <p>Password should be at least 10 characters long and include 1
                                                        uppercase and 1 lower case alpha character, 1 number and 1
                                                        special character . Passwords are case sensitive.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="health_insurance_tax" class="form-control" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('health_insurance_tax'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label">To be paid<span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="to_be_paid" class="form-control" name="to_be_paid" placeholder="">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('to_be_paid'); ?></span>
                                                </div>
                                                <!-- <div class="col-sm-6 mt-2 mt-sm-0">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-sm-12 mt-2 mt-sm-0">
                                                    <label class="form-label">Choose from list<span style="color:red; font-size: 12px"> *</span></label>
                                                    <input type="text" name="choose_from_list" class="form-control" placeholder="">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('choose_from_list'); ?></span>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <label class="form-label">OMG Name<span style="color:red; font-size: 12px">
                                                    *</span></label>
                                            <input type="text" name="omg_name" class="form-control" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('omg_name'); ?></span>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label"></label>
                                        <div class="col-sm-7">
                                            <label class="form-label">Registration No.<span style="color:red; font-size: 12px"> *</span></label>
                                            <input type="text" class="form-control allowNumericWithPlus" onKeyPress="if(this.value.length > 12) return false;" name="registration_no" class="form-control" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('registration_no'); ?></span>
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label"></label>
                                        <div class="col-sm-7">
                                            <label class="form-label">Bank Account<span style="color:red; font-size: 12px"> *</span></label>
                                            <input type="text" name="bank_account" class="form-control allowNumericWithPlus" onKeyPress="if(this.value.length > 24) return false;" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('bank_account'); ?></span>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label">Income<span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-7">
                                            <input type="text" name="income2" class="form-control" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('income2'); ?></span>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="tooltip-info">
                                                <span><a href="javascript:void(0);" class="info-btn"><i class="fa fa-info"></i></a></span>
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label text-danger">To be paid till 2023<span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary"><img src="<?= base_url(); ?>assets/img/save.png" alt="">&nbsp;&nbsp;
                                                Save</button>
                                        </div>
                                    </div>
