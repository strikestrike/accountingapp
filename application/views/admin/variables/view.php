	...
	<div class="container-fluid">
		<!-- <form action="<?= base_url() ?>variable/saveVariableAndVariant" method="post"> -->
			<div class="card project-main pb-0">
				...
				<div class="card-body" id="addVarFormRow">
					<form id="addVariableForm" class="border p-4 rounded" action="<?= base_url() ?>variable/editVariable" method="post">
						<input type="hidden" name="id" value="<?= $variable_info['id'] ?? '' ?>">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="from-group mb-3">
									<label class="form-label">Variable Name</label>
									<input type="text" name="variable_name" value="<?= $variable_info['name'] ?>" class="form-control" placeholder="Enter variable name" required>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="from-group mb-3">
			...
			<input type="hidden" id="active_variable_id" value="<?= $variable_info['id'] ?? '' ?>">
			<div class="card project-main pb-0">
				<div class="card-header">
			...
			<div class="card-body">
				...
				<div class="table-responsive table-border">
					<table class="table ">
						...
						<tbody>
							<?php
							if (!empty($variants_info)) {
								foreach ($variants_info as $var) { ?>
									<tr>
										<td><?= $var['name'] ?></td>
...
<script>
	window.addEventListener('load', function() {
		 ...
		 */
		<?php if(!empty($variable_info['auto_evaluation'])) { ?>
			$("#addVariableForm select[name=auto_evaluation]").selectpicker('val', '<?= $variable_info['auto_evaluation'] ?>')
		<?php } ?>
