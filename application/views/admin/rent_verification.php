                                                ...
                                                <form>
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                                    ...
                                                                    <input type="text" name="" class="form-control" placeholder="Enter Country name">

                                                                </div>
                                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                                    <label class="form-label">City</label>
                                                                    <input type="text" name="" class="form-control" placeholder="Enter City name">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="" class="form-control" placeholder="Assasa">
                                                                </div>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" name="" class="form-control" placeholder="264.339 RON">
                                                        </div>
                                                        <div class="col-sm-2">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                                    <label class="form-label">Tax</label>
                                                                    <input type="text" name="" class="form-control" placeholder="17.372 RON">
                                                                </div>
