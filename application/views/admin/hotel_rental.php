                        ...
                        <div class="project-main2">
                            ...
                            <div class="error_validator" id="hide_data">
                                ...
                                <div class="basic-form">
                                    <form method="POST" action="<?php echo base_url() .'Admin/hotel_rental' ?>">
                                        <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="Date" onKeyPress="if(this.value.length >10) return false;" name="birthday" id="birthday" min="1997-01-01" max="2030-12-31" class="datepicker-default form-control" value="<?php echo set_value('birthday', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
