                    ...
                    <div class="col-xl-12">
                        <div class="project-main2">
                            ...
                            <div class="basic-form">
                                ...
                                <?php echo form_open_multipart('admin/personal_edit/' . base64_encode($personal_list['id'])); ?>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div>
                                            <label class="radio-inline me-3">
                                                <input type="radio" name="salutation" <?= ($personal_list['salutation'] == "Mr") ? "checked" : "" ?> value="Mr">
                                                Mr</label>
                                            <label class="radio-inline me-3">
                                                <input type="radio" name="salutation" <?= ($personal_list['salutation'] == "Mrs") ? 'checked' : '' ?> value="Mrs">
                                                Mrs</label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <?php
                                        $str = $personal_list['name_surname'];
                                        $name = explode(" ", $str);
                                        ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" name="per_number" maxlength="13" id="per_number" class="form-control" placeholder="" value="<?= $personal_list['per_number'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" name="mob_number" maxlength="10" id="mob_number" class="form-control" placeholder="" value="<?= $personal_list['mob_number'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="nationalid" maxlength="2" id="nationalid" class="form-control" placeholder="" value="<?= $personal_list['nationalid'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('nationalid'); ?></span>
                                                </div>

                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                    <input type="text" name="nationalid2" id="nationalid2" maxlength="6" class="form-control" placeholder="" value="<?= $personal_list['nationalid2'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('nationalid'); ?></span>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="date" name="birthday" id="birthday" class="datepicker-default form-control" value="<?= $personal_list['birthday'] ?>" >
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="address" id="address" class="form-control" placeholder="" value="<?= $personal_list['address'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('address'); ?></span>
                                                </div>
                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                    <input type="text" name="address2" id="address2" class="form-control" placeholder="" value="<?= $personal_list['address2'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12 mt-2 mt-sm-0">
                                                    <input type="text" name="address3" id="address3" class="form-control" placeholder="" value="<?= $personal_list['address3'] ?>">
                                                    <span style="color:red; font-size: 12px">
