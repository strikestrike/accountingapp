                        ...
                        <div class="project-main2">
                            ...
                            <div class="error_validator" id="hide_data">
                                ...
                                <div class="basic-form">
                                    <form method="POST" action="<?php echo base_url() . 'Admin/personal_data' ?>">
                                        <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="text" name="name" class="form-control alphabetonly" id="name" onkeypress="return /[a-z]/i.test(event.key)" class="form-control" placeholder="" value="<?php echo set_value('name', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                                                <?php echo form_error('name'); ?></span>
                                                        </div>

                                                        <div class="col-sm-6 mt-2 mt-sm-0">
                                                            <input type="text" onkeypress="return /[a-z]/i.test(event.key)" name="surname" class="form-control alphabetonly" id="surname" class="form-control" placeholder="" value="<?php echo set_value('surname', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <input type="number" class="form-control allowNumericWithPlus" onKeyPress="if(this.value.length > 12) return false;" name="per_number" id="per_number" class placeholder="" value="<?php echo set_value('per_number', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <input type="number" class="allowNumericWithoutDecimal form-control" onKeyPress="if(this.value.length >9) return false;" name=" mob_number" id="mob_number" class="form-control" placeholder="" value="<?php echo set_value('mob_number', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="text" maxlength="2" name="nationalid" id="nationalid" class="form-control" placeholder="" value="<?php echo set_value('nationalid', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                                                <?php echo form_error('nationalid'); ?></span>
                                                        </div>

                                                        <div class="col-sm-6 mt-2 mt-sm-0">
                                                            <input type="text" name="nationalid2" id="nationalid2" class="form-control" maxlength="6" placeholder="" value="<?php echo set_value('nationalid2', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                                                <?php echo form_error('nationalid2'); ?></span>
                                                        </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="Date" onKeyPress="if(this.value.length >10) return false;" name="birthday" id="birthday" min="1950-01-01" max="2030-12-31" class="datepicker-default form-control" value="<?php echo set_value('birthday', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="text" name="address" id="address" class="form-control" placeholder="" value="<?php echo set_value('address', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                                                <?php echo form_error('address'); ?></span>
                                                        </div>

                                                        <div class="col-sm-6 mt-2 mt-sm-0">
                                                            <input type="text" name="address2" id="address2" class="form-control" placeholder="" value="<?php echo set_value(' address', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="row">
                                                        <div class="col-sm-12 mt-2 mt-sm-0">
                                                            <input type="text" name="address3" id="address3" class="form-control" placeholder="" value="<?php echo set_value(' address', ''); ?>">
                                                            <span style="color:red; font-size: 12px">
