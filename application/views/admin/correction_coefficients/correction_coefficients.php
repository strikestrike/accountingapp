...
<div class="content-body content-area-scroll">
	<div class="container-fluid">
		<form id="coefForm" action="<?= base_url() ?>admin/saveCoef" method="post">
					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="from-group mb-3">
								...
								<input type="text" name="coef_var_name" id="coef_var_name" class="form-control">
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<input type="text" name="coef_value" id="coef_value" class="form-control">
							</div>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="form-group">
...
<script>
	...
	$("#coefForm").submit(function(e) {
		...
		submitHandler: function(form) {
			...
			saveCoefDetails(saveData).then(data => {
				if (data == 'success') {
					window.location.href = '<?= base_url() ?>admin/coeffSavedSuccess'
				}
			})
	...
	async function saveCoefDetails(data) {
		const url = '<?= base_url() ?>admin/saveCoef'
