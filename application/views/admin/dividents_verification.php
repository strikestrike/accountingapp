                    ...
                    <div class="col-xl-12">
                        <div class="project-main2">
                            ...
                            <div class="basic-form">
                                <form method="POST" action="<?php echo base_url() . 'Admin/dividents_verification' ?>">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control allowNumericWithPlus" class="allowNumericWithoutDecimal name=" per_number" onKeyPress="if(this.value.length > 11) return false;" maxlength="13" placeholder="">
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <hr>
                                    <h6>Information "Product name" 2021 <span style="color:red; font-size: 12px">
                                            *</span></h6>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="income1" class="form-control" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label text-danger">To be paid till May 2022
                                            <span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="to_be_paid_till_may_2022" class="form-control" placeholder="">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('to_be_paid_till_may_2022'); ?></span>
                                                </div>
                                                <!--  <div class="col-sm-6 mt-2 mt-sm-0">
                                                                    <input type="text" name="to_be_paid_till_may_2022" class="form-control" placeholder="">
                                                                    <?php echo form_error('to_be_paid_till_may_2022'); ?>
                                                                </div> -->
                                        ...
                                        <div class="col-sm-2">
                                            <div class="tooltip-info">
                                                ...
                                                <div class="main">
                                                    <p>Password should be at least 10 characters long and include 1
                                                        uppercase and 1 lower case alpha character, 1 number and 1
                                                        special character . Passwords are case
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label text-danger">To be paid till May
                                            2023 <span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-7">
                                            <input type="text" name="to_be_paid_unit_may_2023" class="form-control" placeholder="">
                                            <span style="color:red; font-size: 12px">
                                                <?php echo form_error('to_be_paid_unit_may_2023'); ?></span>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="tooltip-info">
                                                <span><a href="javascript:void(0);" class="info-btn"><i class="fa fa-info"></i></a></span>
