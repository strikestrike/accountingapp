                        ...
                        <div class="project-main2">
                            ...
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-4 col-lg-4 col-sm-6 mb-3">
                                    <p class="mb-0 small">Retrieving information from <br>2021 &#8243;Project
                                        name&#8243;</p>
                                </div>
                            ...
                            <div class="basic-form">
                                ...
                                <?php echo form_open_multipart('Admin/personaldata_view/' . base64_encode($personal_data_list['id'])); ?>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div>
                                            <label class="radio-inline me-3">
                                                <input type="radio" name="salutation" <?= ($personal_data_list['salutation'] == "Mr") ? "checked" : "" ?> value="Mr" readonly>
                                                Mr</label>
                                            <label class="radio-inline me-3">
                                                <input type="radio" name="salutation" <?= ($personal_data_list['salutation'] == "Mrs") ? 'checked' : '' ?> value="Mrs" readonly>
                                                Mrs</label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <?php
                                        $str = $personal_data_list['name_surname'];
                                        $name = explode(" ", $str);
                                        ?>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" onkeypress="return /[a-z]/i.test(event.key)" name="name" id="name" class="form-control" placeholder="" value="<?= $srname = $name[0] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('name'); ?></span>
                                                </div>

                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                    <input type="text" onkeypress="return /[a-z]/i.test(event.key)" name="surname" id="surname" class="form-control" placeholder="" value="<?= $srname = $name[1] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" name="per_number" maxlength="13" id="per_number" class="form-control" placeholder="" value="<?= $personal_data_list['per_number'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label">Mobile number <span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" name="mob_number" maxlength="10" id="mob_number" class="form-control" placeholder="" value="<?= $personal_data_list['mob_number'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label">National Id Data <span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="nationalid" maxlength="2" id="nationalid" class="form-control" placeholder="" value="<?= $personal_data_list['nationalid'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('nationalid'); ?></span>
                                                </div>

                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                    <input type="text" name="nationalid2" id="nationalid2" maxlength="6" class="form-control" placeholder="" value="<?= $personal_data_list['nationalid2'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('nationalid'); ?></span>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                        <label class="col-sm-3 col-form-label">Birthday <span style="color:red; font-size: 12px"> *</span></label>
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="date" name="birthday" id="birthday" class="datepicker-default form-control" value="<?= $personal_data_list['birthday'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" name="address" id="address" class="form-control" placeholder="" value="<?= $personal_data_list['address'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('address'); ?></span>
                                                </div>
                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                    <input type="text" name="address2" id="address2" class="form-control" placeholdpersonal_data_lister="" value="<?= $personal_data_list['address2'] ?>" readonly>
                                                    <span style="color:red; font-size: 12px">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-12 mt-2 mt-sm-0">
                                                    <input type="text" name="address3" id="address3" class="form-control" placeholder="" value="<?= $personal_data_list['address3'] ?>">
                                                    <span style="color:red; font-size: 12px">
                                                        <?php echo form_error('address3'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-10">
                                            <a href="<?php echo base_url('Admin/create_user'); ?>"><button type="button" src="" class="btn btn-primary"><img alt="">&nbsp;&nbsp; Back</button></a>
                                        </div>
                                    </div>
                                    </form>
                                </div>
