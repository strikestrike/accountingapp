                        ...
                        <div class="col-xl-12">
                            <div class="project-main2">
                                ...
                                <div class="basic-form">
                                        <form action="<?= base_url('admin/saveClientStocksVerification') ?>" method="POST">
                                                ...
                                                <div class="col-sm-7 divident-2021-wrapper">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 mt-2 mt-sm-0">
                                                            <label class="form-label">Var Final </label>
                                                        </div>
                                                        <div class="col-sm-4 mt-2 mt-sm-0">
                                                    ...
                                                    <?php if (!empty($calculatedDividentList)) {
                                                        foreach ($calculatedDividentList as $key => $value) { ?>
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="divident-2021-inputs">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4 mt-2">
                                                                                    <input type="text" name="" data-name="divident" class="form-control processDivident" placeholder="var final">
                                                                                </div>
                                                                                <div class="col-sm-4 mt-2">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-2">
                                                    <label class="ong-radio">
                                                        <input class="ong_question" type="checkbox" id="ong_question" name="ong_question" value="1" <?= !empty($ong_data) ? '' : 'checked'?>>
														<input type="hidden" id="ong_id" name="ong_id" <?= !empty($ong_data) ? 'value = "'.$ong_data['id'].'"' : ''?>>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="text" name="ong_name" id="ong_name" class="form-control" placeholder="ONG Name" required <?= !empty($ong_data) ? 'value = "'.$ong_data['ong_name'].'"' : 'disabled'?>>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <label class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="number" name="ong_registration_number" id="ong_registration_number" class="form-control" placeholder="Registration No." required <?= !empty($ong_data) ? 'value = "'.$ong_data['ong_registration_number'].'"' : 'disabled'?>>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <label class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="number" name="ong_bank_account" id="ong_bank_account" class="form-control" placeholder="A/c. 123XXXXXXXXXX" required <?= !empty($ong_data) ? 'value = "'.$ong_data['ong_bank_account'].'"' : 'disabled'?>>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-7">
													<select class="form-control" name="need_health_insurance" onchange="checkDropdown(this)">
                                            ...
                                            <div class="row form-group" id="ifYesIncome" <?= !empty($existing_data) ? ($existing_data['need_health_insurance'] == 1 ? '' : 'style="display: none;"') : 'style="display: none;"' ?>>
                                                <label class="col-sm-3 col-form-label"> Income</label>
                                                <div class="col-sm-7">
                                                    <input type="text" id="ifYesIncome2022" name="income_2022" class="form-control" placeholder="3.060 RON" oninput="calculate2022Data(this.value)" <?= !empty($existing_data) ? ($existing_data['need_health_insurance'] == 1 ? 'value = "'.$existing_data['income_2022'].'"' : 'disabled') : 'disabled' ?>>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="tooltip-info">
                                                        <span><a href="javascript:void(0);" class="info-btn"><i class="fa fa-info"></i></a></span>
                                            ...
                                            <div class="row form-group" id="ifYesTobePaid" <?= !empty($existing_data) ? ($existing_data['need_health_insurance'] == 1 ? '' : 'style="display: none;"') : 'style="display: none;"' ?>>
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="tax_2022" id="ifYesTobePaid2022" class="form-control" placeholder="3.060 RON" <?= !empty($existing_data) ? ($existing_data['need_health_insurance'] == 1 ? 'value = "'.$existing_data['tax_2022'].'"' : 'disabled') : 'disabled' ?>>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="tooltip-info">
                                                        <span><a href="javascript:void(0);" class="info-btn"><i class="fa fa-info"></i></a></span>
