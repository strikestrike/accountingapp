                                    ...
                                    <div class="col-xl-12">
                                        <div class="project-main2">
                                            ...
                                            <div class="d-flex justify-content-end align-items-center">
                                               ...
                                               <a class="btn btn-primary text-nowrap" href="#" data-bs-toggle="modal" data-bs-target="#"> Add new user</a>
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-responsive-sm">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>Lonlonesou</td>
                                                            <td>12345 46874683</td>
                                                            <td class="color-primary">
                                                                <div class="d-flex">
                                                                    <a href="javascript:void(0);" class="btn btn-primary shadow btn-xs1 sharp1 me-1">View</a>
                                                                    <a href="javascript:void(0);" class="btn btn-primary shadow btn-xs1 sharp1 me-1">Edit</a>
                                                                    <a href="javascript:void(0);" class="btn btn-danger shadow btn-xs1 sharp1">Delete</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
