                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="project-main2">
								...
								// print_r($_SESSION);
								?>
								<form id="<?= !empty($rentIncome) ? 'incomeTypeForm' : 'hotel_form' ?>" class="<?= !empty($rentIncome) ? 'editable' : '' ?>" action="<?= !empty($rentIncome) ? base_url() . 'admin/updateClientHotelIncome' : '' ?>" method="POST">
									<div class="row">
													...
													<?php if (!empty($rentIncome)) { ?>
														...
														<?php if (!empty($personalData)) { ?>
															...
															<?php } elseif ($personalData['steps_completed'] >= 2) { ?>
																<a href="<?= base_url()?>admin/clientHotelIncomeVerification/<?= $personalData['id'] ?>" class="btn btn-primary nextStep"><i class="fas fa-forward"></i> Next</a>
															<?php } ?>
														<?php } ?>
													<?php } else { ?>
